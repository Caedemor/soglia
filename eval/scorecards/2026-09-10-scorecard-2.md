# Stage-1 eval scorecard — 2026-09-10 (scorecard-2)
...
stability: {'runs': 2, 'identical_outcomes': True}

## polish: PASS
gates: map_valid=ok, recall=ok, held_arithmetic=ok, engine_path=ok
guests 52 (matched 46, extras 6); held 0; flagged 6, unrecognized 2; role 20; completeness awaiting_completion
...
## textmail: PASS
gates: map_valid=ok, recall=ok, held_arithmetic=ok, required_fields=ok, engine_path=ok
guests 47 (matched 47, extras 0); held 2; flagged 0, unrecognized 0; role 16; completeness awaiting_completion
coverage: {'sesso': 0, 'data_nascita': 47, 'cittadinanza': 0, 'tipo_documento': 0, 'numero_documento': 46}
field accuracy (exact/labelled): {'data_nascita': {'exact': 47, 'of': 47}, 'numero_documento': {'exact': 46, 'of': 46}}
hand-map outcome parity: [True, True]
stability: {'runs': 2, 'identical_outcomes': True}
